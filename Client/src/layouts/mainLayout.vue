    ...
    <Disclosure as="nav" class="border-b border-gray-200 bg-white" v-slot="{ open }">
        ...
        <div class="flex h-16 justify-between">
          <div class="flex">
            <div class="flex flex-shrink-0 items-center">
              <img class="block h-8 w-8" src="/vite.svg" alt="Your Company" />
            </div>
            <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
              <router-link v-for="item in navigation" :key="item.name" :to="{ path: item.path }" :class="[
                item.current
            ...
            <Menu as="div" class="relative ml-3">
              ...
              <transition enter-active-class="transition ease-out duration-200"
                ...
                <MenuItems
                  ...
                  <router-link :to="{ path: item.path }" :class="[
                    active ? 'bg-gray-100' : '',
      ...
      <DisclosurePanel class="sm:hidden">
        <div class="space-y-1 pt-2 pb-3">
          <DisclosureButton v-for="item in navigation" :key="item.name" as="a" :href="item.path" :class="[
            item.current
        ...
        <div class="border-t border-gray-200 pt-4 pb-3">
          ...
          <div class="mt-3 space-y-1">
            <DisclosureButton v-for="item in navigation" :key="item.name" as="a" :href="item.path"
